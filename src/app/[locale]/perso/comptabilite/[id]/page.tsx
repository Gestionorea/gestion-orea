...
export default async function EditTransactionPage({
  ...
  const [t, transaction, properties, companies, categories] = await Promise.all([
  ...
  return (
    <div className="py-8">
      ...
      <EditTransactionForm transaction={transaction} properties={properties} companies={companies} categories={categories} />
    </div>
  );
}
